// uart_bridge_core_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module uart_bridge_core_mm_interconnect_0 (
	...
	wire  [101:0] packets_to_master_0_avalon_master_agent_cp_data;                                      // packets_to_master_0_avalon_master_agent:cp_data -> router:sink_data
	...
	wire  [101:0] router_src_data;                                                                      // router:src_data -> packets_to_master_0_avalon_master_limiter:cmd_sink_data
	wire          router_src_ready;                                                                     // packets_to_master_0_avalon_master_limiter:cmd_sink_ready -> router:src_ready
	wire    [1:0] router_src_channel;                                                                   // router:src_channel -> packets_to_master_0_avalon_master_limiter:cmd_sink_channel
	...
	wire  [101:0] packets_to_master_0_avalon_master_limiter_cmd_src_data;                               // packets_to_master_0_avalon_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire    [1:0] packets_to_master_0_avalon_master_limiter_cmd_src_channel;                            // packets_to_master_0_avalon_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire  [101:0] rsp_mux_src_data;                                                                     // rsp_mux:src_data -> packets_to_master_0_avalon_master_limiter:rsp_sink_data
	wire          rsp_mux_src_ready;                                                                    // packets_to_master_0_avalon_master_limiter:rsp_sink_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                                  // rsp_mux:src_channel -> packets_to_master_0_avalon_master_limiter:rsp_sink_channel
	...
	wire  [101:0] packets_to_master_0_avalon_master_limiter_rsp_src_data;                               // packets_to_master_0_avalon_master_limiter:rsp_src_data -> packets_to_master_0_avalon_master_agent:rp_data
	...
	wire    [1:0] packets_to_master_0_avalon_master_limiter_rsp_src_channel;                            // packets_to_master_0_avalon_master_limiter:rsp_src_channel -> packets_to_master_0_avalon_master_agent:rp_channel
	...
	wire    [1:0] packets_to_master_0_avalon_master_limiter_cmd_valid_data;                             // packets_to_master_0_avalon_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	uart_bridge_core_mm_interconnect_0_router router (
	...
	uart_bridge_core_mm_interconnect_0_router_001 router_001 (
	...
	uart_bridge_core_mm_interconnect_0_router_001 router_002 (
	...
	uart_bridge_core_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                   //        clk.clk
		.reset              (packets_to_master_0_clk_reset_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	uart_bridge_core_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                             //       clk.clk
		.reset               (packets_to_master_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_bridge_core_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                             //       clk.clk
		.reset               (packets_to_master_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_bridge_core_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                             //       clk.clk
		.reset              (packets_to_master_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_bridge_core_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                             //       clk.clk
		.reset              (packets_to_master_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_bridge_core_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                             //       clk.clk
		.reset               (packets_to_master_0_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_bridge_core_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
